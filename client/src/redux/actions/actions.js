...
export function createBreed(payload) {
    return async function (dispatch) {
        const response = await axios.post(`https://pi-dogs-back-production.up.railway.app/dog`, payload);
...
export function getBreeds() {
    return (dispatch) => {
        return axios("https://pi-dogs-back-production.up.railway.app/dogs/")
...
export function getBreedDetail(id) {
    return (dispatch) => {
        return axios(`https://pi-dogs-back-production.up.railway.app/dogs/${id}`)
...
export function searchBreed(name) {
    return function (dispatch) {
        return axios(`https://pi-dogs-back-production.up.railway.app/dogs/?name=${name}`)
...
export function getTemperament() {
    return function (dispatch) {
        return axios(`https://pi-dogs-back-production.up.railway.app/temperament`)
